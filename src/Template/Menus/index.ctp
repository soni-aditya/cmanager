    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('List of') ?> Menus</h3>
          <div class="box-tools">
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th><?= $this->Paginator->sort('has_child') ?></th>
            ...
            <?php foreach ($menus as $menu): ?>
              <tr>
                ...
                <td><?= h($menu->has_child) ?></td>
                <td><?= h($menu->display) ?></td>
                <td class="actions" style="white-space:nowrap">
                  ...
                  <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $menu->id], ['confirm' => __('Confirm to delete this entry?'), 'class'=>'btn btn-danger btn-xs']) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
