 ...
 * @property \App\Model\Table\RevieversTable|\Cake\ORM\Association\BelongsTo $Revievers
 *
...
class RatingsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Revievers', [
            'foreignKey' => 'reviever_id',
            'joinType' => 'INNER',
            'className'=> 'Users'
        ]);
    }
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('note_of_advice')
            ->requirePresence('note_of_advice', 'create')
            ->notEmpty('note_of_advice');
