    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('List of') ?> Ratings</h3>
          <div class="box-tools">
            ...
            <?php foreach ($ratings as $rating): ?>
              <tr>
                ...
                <td class="actions" style="white-space:nowrap">
                  ...
                  <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $rating->id], ['confirm' => __('Confirm to delete this entry?'), 'class'=>'btn btn-danger btn-xs']) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
